...
import jhernandez.gameclock.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class GameBridge extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_bridge);
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        AlarmReceiver.deactivateAlarm(getApplicationContext(), alarm);
